...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">SR Wedding Planners</a>
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4">SR Wedding Planners</h1>
          <p class="intro-subtitle"><span class="text-slider-items">Make Your Wedding Memorable</span><strong class="text-slider"></strong></p>
          ...
          <div id="testimonial-mf" class="owl-carousel owl-theme">
            <div class="testimonial-box">
              <div class="author-test">
                ...
                <span class="author">Sanjana </span>
              </div>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="copyright-box">
              <p class="copyright">&copy; Copyright <strong>SR Wedding Planners</strong>. All Rights Reserved</p>
              <div class="credits">
                <!--
